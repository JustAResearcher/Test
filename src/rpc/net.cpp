        ...
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
    ...
    auto conn_type_in{util::TrimStringView(self.Arg<std::string>("connection_type"))};
        ...
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
    ...
    bool success;
    auto address{self.MaybeArg<std::string>("address")};
        ...
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
    ...
    if (auto node{self.MaybeArg<std::string>("node")}) {
        bool found = false;
...
{
    auto command{help.Arg<std::string>("command")};
    ...
    CSubNet subNet;
    CNetAddr netAddr;
    std::string subnet_arg{help.Arg<std::string>("subnet")};
...
static RPCHelpMan sendmsgtopeer()
{
    return RPCHelpMan{
        ...
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue {
            ...
            const auto msg_type{self.Arg<std::string>("msg_type")};
            ...
            auto msg{TryParseHex<unsigned char>(self.Arg<std::string>("msg"))};
            if (!msg.has_value()) {
