...
#ifndef MEOWCOIN_HASH_X16R_H
#define MEOWCOIN_HASH_X16R_H
...
// Algorithm selection globals for debugging/statistics
    ...
    for (int i = 0; i < 16; i++)
    {
        ...
        switch(hashSelection) {
            ...
            case 3:
                ...
                break;
            case 4:
                // X16RV2: tiger -> keccak (double hash)
            ...
            case 5:
                ...
                break;
            case 6:
                // X16RV2: tiger -> luffa (double hash)
                sph_tiger_init(&ctx_tiger);
                sph_tiger(&ctx_tiger, toHash, lenToHash);
                sph_tiger_close(&ctx_tiger, static_cast<void*>(&hash[i]));
            ...
            case 14:
                ...
                break;
            case 15:
                // X16RV2: tiger -> sha512 (double hash)
                sph_tiger_init(&ctx_tiger);
                sph_tiger(&ctx_tiger, toHash, lenToHash);
                sph_tiger_close(&ctx_tiger, static_cast<void*>(&hash[i]));
...
// KawPow/MeowPow hash function declarations
